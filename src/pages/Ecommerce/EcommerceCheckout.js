                                ...
                                <CardBody className="checkout-tab">
                                  ...
                                  <span className="mb-4 fw-semibold d-block text-muted text-uppercase">
                                    ...
                                    Marcus Alfaro
                                                                    ...
                                                                    <span
                                                                        className="text-muted fw-normal text-wrap mb-1 d-block">
                                    ...
                                    Mo. 012-345-6789
                                                            ...
                                                            <div
                                                                className="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                                                                <div>
                                                                    <Link
                                                                        to="#"
                                  ...
                                  <span className="mb-4 fw-semibold d-block text-muted text-uppercase">
                                    ...
                                    <span className="fs-20 float-end mt-2 text-wrap d-block fw-semibold">
                                      ...
                                      Free Delivery
                                                                        ...
                                                                        <span
                                                                            className="text-muted fw-normal text-wrap d-block">
