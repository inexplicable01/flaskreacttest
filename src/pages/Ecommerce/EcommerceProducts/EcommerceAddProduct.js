                                        ...
                                        <div className="text-center">
                                            <div className="position-relative d-inline-block">
                                                <div className="position-absolute top-100 start-100 translate-middle">
                                                    ...
                                                    <input className="form-control d-none" defaultValue=""
                                                ...
                                                <Col lg={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        {validation.errors.manufacturer_name && validation.touched.manufacturer_name ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.manufacturer_name}</FormFeedback>
                                                        ) : null}
                                                    </div>
                                                </Col>
                                                <Col lg={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        {validation.errors.manufacturer_brand && validation.touched.manufacturer_brand ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.manufacturer_brand}</FormFeedback>
                                                        ) : null}
                                                    </div>
                                                </Col>
                                            </Row>
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <div className="input-group mb-3">
                                                            ...
                                                            {validation.errors.stock && validation.touched.stock ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.stock}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </div>
                                                </Col>
                              ...
                              >
                                $
                                                            ...
                                                            {validation.errors.price && validation.touched.price ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.price}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </div>
                                                </Col>
                              ...
                              >
                                %
                                                            ...
                                                            {validation.errors.product_discount && validation.touched.product_discount ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.product_discount}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </div>
                                                </Col>
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <div className="input-group mb-3">
                                                            ...
                                                            {validation.errors.orders && validation.touched.orders ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.orders}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </div>
                                                </Col>
                                                ...
                                                <Col lg={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        {validation.errors.meta_title && validation.touched.meta_title ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.meta_title}</FormFeedback>
                                                        ) : null}
                                                    </div>
                                                </Col>
                                                ...
                                                <Col lg={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        {validation.errors.meta_keyword && validation.touched.meta_keyword ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.meta_keyword}</FormFeedback>
                                                        ) : null}
                                                    </div>
                                                </Col>
                                            </Row>
