                            ...
                            <Row>
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={4}>
                                                <img className="rounded-start img-fluid h-100 object-cover" src={img12}
                                                     alt="Card"/>
                                            </Col>
                                            <Col md={8}>
                                                <CardHeader>
                                    ...
                                    <Card>
                                        <Row className="g-0">
                                            ...
                                            <div className="col-md-4">
                                                <img className="rounded-end img-fluid h-100 object-cover" src={img4}
                                                     alt="Card"/>
                                            </div>
                                        </Row>
                                    </Card>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={4}>
                                                <img className="rounded-start img-fluid h-100 object-cover" src={img9}
                                                     alt="Card"/>
                                            </Col>
                                            <Col md={8}>
                                                <CardBody>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            ...
                                            <Col md={4}>
                                                <img className="rounded-end img-fluid h-100 object-cover" src={img2}
                                                     alt="Card"/>
                                            </Col>
                                        </Row>
                                    </Card>
                    ...
                    <Row>
                        ...
                        <Col xxl={4}>
                            <Card className="card-light">
                                ...
                                <div className="card-footer">
                                    <div className="text-center">
                                        <Link to="#" className="link-dark">Connect Now <i
                                            className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="border card-border-dark">
                                ...
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the
                                        ...
                                        sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="link-dark fw-medium">Read More <i
                                            className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
