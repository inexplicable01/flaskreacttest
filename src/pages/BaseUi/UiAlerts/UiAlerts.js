                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-borderless</code> class to set alert
                                        without border.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>UncontrolledAlert</code> tag to add
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-outline</code> class to set an alert
                                        with outline.</p>
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="primary"
                                                    ...
                                                    <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> -Label
                                                    icon alert
                                                </UncontrolledAlert>
