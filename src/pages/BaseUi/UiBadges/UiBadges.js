                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>badge-soft-</code> class with the
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>badge-outline-</code> class with the
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use the <code>rounded-pill badge-soft-</code> class with
                                        the below-mentioned variation
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <span
                                                className="badge rounded-pill badge-outline-secondary">Secondary</span>
                                            ...
                                            <span
                                                className="badge rounded-pill badge-outline-light text-dark">Light</span>
                                        </div>
                                    </div>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <Badge color="light" className="badge-label text-dark"> <i
