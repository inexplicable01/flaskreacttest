                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>animated-progess custom-progess </code> class to
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>animated-progess custom-progess
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Progress multi className='progress-step-arrow progress-info'>
                                            ...
                                            <Progress bar value="35" color="light" className="text-dark"> Step
                                                3 </Progress>
                                        </Progress>
                                    </div>
