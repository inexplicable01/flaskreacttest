                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button color="info" id="grid-view-button"
                                                className="btn btn-soft-info nav-link btn-icon fs-14 active filter-button shadow-none"><i
                                            className="ri-grid-fill"></i></Button>
                                        <Button color="info" id="list-view-button"
                                                className="btn btn-soft-info nav-link  btn-icon fs-14 filter-button shadow-none"><i
                                    ...
                                    <OffcanvasBody className="profile-offcanvas p-0">
                                        ...
                                        <div className="p-3 border-top">
                                            ...
                                            <div className="d-flex">
                                                <div className="flex-shrink-0 avatar-xs">
                                                    <div
                                                        className="avatar-title bg-soft-primary text-primary rounded fs-16">
