                                            ...
                                            <div className="verti-sitemap">
                                                <ul className="list-unstyled mb-0">
                                                    <li className="p-0 parent-title"><Link to="#"
                                                        ...
                                                        Martino - Project Director</Link></li>
                                                    <li>
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#"
                                                                      className="fw-medium text-primary">Mary Jones -
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#"
                                                                      className="fw-medium text-primary">Rachel Rose -
                                                                    HR</Link>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0 list-unstyled">
                                                    <li className="p-0 parent-title"><Link to="#"
                                                                                           className="fw-medium fs-14">Velzon</Link>
                                                    </li>
                                                    <li>
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-pencil-ruler-2-line me-1 align-bottom"></i> App
                                                                    Pages</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-file-list-3-line me-1 align-bottom"></i> Pages</Link>
                                                            </div>
                                                        </div>
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-stack-line me-1 align-bottom"></i> Components</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                                <li>
