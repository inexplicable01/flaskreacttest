                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    ...
                                                    {validation.errors.postalcode && validation.touched.postalcode ? (
                                                        <FormFeedback
                                                            type="invalid">{validation.errors.postalcode}</FormFeedback>
                                                    ) : null}
                                        ...
                                        <Col lg={4} className="ms-auto">
                                            <div className="mb-2">
                                                ...
                                                {validation.errors.registration && validation.touched.registration ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.registration}</FormFeedback>
                                                ) : null}
                                            </div>
                                            <div className="mb-2">
                                                <Input
                                            ...
                                            <div className="mb-2">
                                                ...
                                                {validation.errors.website && validation.touched.website ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.website}</FormFeedback>
                                                ) : null}
                                            ...
                                            <div>
                                                ...
                                                {validation.errors.contact && validation.touched.contact ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.contact}</FormFeedback>
                                                ) : null}
                                    ...
                                    <Row className="g-3">
                                        <Col lg={3} sm={6}>
                                            ...
                                            {validation.errors.invoiceId && validation.touched.invoiceId ? (
                                                <FormFeedback
                                                    type="invalid">{validation.errors.invoiceId}</FormFeedback>
                                            ) : null}
                                        </Col>
                                        <Col lg={3} sm={6}>
                                            <div>
                                                ...
                                                >
                                                    {allstatus.map((item, key) => (
                                                        <React.Fragment key={key}>
                                                            {item.options.map((item, key) => (<option value={item.value}
                                        ...
                                        <Col lg={4} sm={6}>
                                            ...
                                            <div className="mb-2">
                                                ...
                                                {validation.errors.billing_address && validation.touched.billing_address ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.billing_address}</FormFeedback>
                                                ) : null}
                                            ...
                                            <div className="mb-2">
                                                ...
                                                {validation.errors.billing_phone && validation.touched.billing_phone ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.billing_phone}</FormFeedback>
                                                ) : null}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                {validation.errors.billing_taxno && validation.touched.billing_taxno ? (
                                                    <FormFeedback
                                                        type="invalid">{validation.errors.billing_taxno}</FormFeedback>
                                                ) : null}
                                                ...
                                                <Col lg={8}>
                                                    ...
                                                    <div className="mb-2">
                                                        ...
                                                        {validation.errors.shipping_name && validation.touched.shipping_name ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.shipping_name}</FormFeedback>
                                                        ) : null}
                                                    ...
                                                    <div className="mb-2">
                                                        ...
                                                        {validation.errors.shipping_address && validation.touched.shipping_address ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.shipping_address}</FormFeedback>
                                                        ) : null}
                                                    ...
                                                    <div className="mb-2">
                                                        ...
                                                        {validation.errors.shipping_phone && validation.touched.shipping_phone ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.shipping_phone}</FormFeedback>
                                                        ) : null}
                                                    ...
                                                    <div>
                                                        ...
                                                        {validation.errors.shipping_taxno && validation.touched.shipping_taxno ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.shipping_taxno}</FormFeedback>
                                                        ) : null}
                                        ...
                                        <Table className="invoice-table table-borderless table-nowrap mb-0">
                                            ...
                                            <tr className="table-active">
                                                ...
                                                <th scope="col" style={{width: "120px"}}>
                                                    <div
                                                        className="d-flex currency-select input-light align-items-center">
                                                        Rate
                                                        <Select
                                                ...
                                                <td className="text-start">
                                                    <div className="mb-2">
                                                        ...
                                                        {validation.errors.product_name && validation.touched.product_name ? (
                                                            <FormFeedback
                                                                type="invalid">{validation.errors.product_name}</FormFeedback>
                                                        ) : null}
                                            ...
                                            <tr id="newForm" style={{display: "none"}}>
                                                <td className="d-none" colSpan="5"><p>Add New Form</p></td>
                                            </tr>
                                            <tr>
                                                <td colSpan="5">
                                                    <Link
                                            ...
                                            <tr className="border-top border-top-dashed mt-2">
                                                ...
                                                <td colSpan="2" className="p-0">
                                                    <Table
                                                        className="table-borderless table-sm table-nowrap align-middle mb-0">
                                                        <tbody>
                                                        <tr>
