                ...
                Cell: (transation) => (
                    <>
                        <div className="avatar-xs">
                            <div
                                className={"avatar-title bg-soft-" + transation.row.original.iconClass + " text-" + transation.row.original.iconClass + " rounded-circle fs-16"}>
            ...
            <Row className="align-items-center mb-4 g-3">
                <Col sm={2}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <select className="form-control mb-0" data-choices data-choices-search-false
                ...
                <div className="col-sm-auto ms-auto">
                    <div className="d-flex gap-2">
                        <Link to="#" data-bs-toggle="modal" className="btn btn-info"
                              onClick={() => flowType("Deposit")}>Deposite</Link>
                        <Link to="#" data-bs-toggle="modal" className="btn btn-danger"
                              onClick={() => flowType("Withdraw")}>Withdraw</Link>
                    </div>
                </div>
            </Row>
