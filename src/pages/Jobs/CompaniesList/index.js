                      ...
                      <span className="icon-on">
                        ...
                        <i className="ri-user-unfollow-line align-bottom me-1"></i>{" "}
                            ...
                            <Card className="overflow-hidden shadow-none">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="flex-shrink-0">
                                            <div className="avatar-sm">
                                                <div
                                                    className="avatar-title bg-soft-danger text-danger rounded-circle fs-17">
                                ...
                                <CardBody
                                    className="bg-soft-danger border-top border-danger border-opacity-25 border-top-dashed">
                                    <Link
                                        to="#!"
