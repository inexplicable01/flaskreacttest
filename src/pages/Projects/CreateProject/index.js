                    ...
                    <Row>
                        <Col lg={8}>
                            <Card>
                                <CardBody>
                                    <div className="mb-3">
                                        <Label className="form-label" htmlFor="project-title-input">Project
                                            Title</Label>
                                    ...
                                    <div className="mb-3">
                                        <Label className="form-label" htmlFor="project-thumbnail-img">Thumbnail
                                            Image</Label>
                                        <Input className="form-control" id="project-thumbnail-img" type="file"
                                    ...
                                    <Row>
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                <Label htmlFor="choices-priority-input"
                                                       className="form-label">Priority</Label>
                                        ...
                                        <Col lg={4}>
                                            <div>
                                                <Label htmlFor="datepicker-deadline-input"
                        ...
                        <Col lg={4}>
                            <div className="card">
                                ...
                                <CardBody>
                                    <div>
                                        <Label htmlFor="choices-privacy-status-input"
                                               className="form-label">Status</Label>
                                        <select className="form-select" data-choices data-choices-search-false
                            ...
                            <div className="card">
                                ...
                                <CardBody>
                                    <div className="mb-3">
                                        <Label htmlFor="choices-categories-input"
                                    ...
                                    <div>
                                        ...
                                        <div className="avatar-group">
                                            ...
                                            <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip"
                                                ...
                                                <div className="avatar-xs" data-bs-toggle="modal"
