                    ...
                    <Row className="justify-content-center">
                        <Col xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <p className="text-muted fs-13">WalletConnect is a convenient open source tool that
                                    enables a mobile wallet to easily connect to decentralized web applications, and
                                    interact with them from your phone.</p>
                            </div>
                        </Col>
                    </Row>
                        ...
                        <Col lg={3}>
                            <Card className="text-center">
                                <CardBody className="py-5 px-4">
                                    ...
                                    <h5>Metamask</h5>
                                    <p className="text-muted pb-1">MetaMask is a software cryptocurrency wallet used to
