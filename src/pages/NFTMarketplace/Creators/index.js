                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                ...
                                                <p className="text-muted mb-0"><i
                                                    className="mdi mdi-ethereum text-primary fs-14"></i> {item.price}
                                                </p>
                                            </div>
                                            <div>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <p className="text-muted">You can make an NFT of a digital painting, a text, a
                                            piece of music, a video.</p>
                                        <button
                                            className={item.isFollowBtn ? "btn btn-success w-100" : "btn btn-soft-success w-100"}>{item.isFollowBtn ? "Follow" : "Unfollow"}</button>
                                    </div>
                                </Card>
                            </Col>
                        ))}
                        ...
                        <Col sm={6}>
                            <div>
                                <p className="mb-sm-0 text-muted">Showing <span
                                    className="fw-semibold">1</span> to <span className="fw-semibold">10</span> of <span
