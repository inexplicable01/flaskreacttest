                    ...
                    <Row>
                        <Col xxl={9}>
                                            ...
                                            <ul className="nav nav-pills filter-btns" role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button type="button" data-filter="all"
                                                            ...
                                                            className={displayCategory === "All" ? "nav-link fw-medium active" : "nav-link fw-medium"}>All
                                                        Items
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button type="button" data-filter="upto-15"
                                                            onClick={() => setCategory("upto-15")}
                                                            className={displayCategory === "upto-15" ? "nav-link fw-medium active" : "nav-link fw-medium"}>Up
                                                        to 15%
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button type="button" data-filter="upto-30"
                                                            onClick={() => setCategory("upto-30")}
                                                            className={displayCategory === "upto-30" ? "nav-link fw-medium active" : "nav-link fw-medium"}>Up
                                                        to 30%
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button type="button" data-filter="upto-40"
                                                            onClick={() => setCategory("upto-40")}
                                                            className={displayCategory === "upto-40" ? "nav-link fw-medium active" : "nav-link fw-medium"}>Up
                                                        to 40%
                                                    </button>
                                                </li>
                                            </ul>
                            ...
                            <Row>
                                ...
                                {(aution.filter(({category}) => displayCategory === category || displayCategory === "All")).map((item, key) => (
                                        ...
                                        <Card className="explore-box card-animate">
                                            ...
                                            <CardBody>
                                                <p className="fw-medium mb-0 float-end"><i
                                                    className="mdi mdi-heart text-danger align-middle"></i> {item.likes}k
                                                </p>
                                                <h5 className="text-success"><i
                                                    className="mdi mdi-ethereum"></i> {item.price} ETH </h5>
                                                <h6 className="fs-16 mb-3"><Link
                                                    to="/apps-nft-item-details">{item.title}</Link></h6>
                                                <div>
                                                    <span
                                                        className="text-muted float-end">Available: {item.available}</span>
                                                    ...
                                                    <div className="progress progress-sm mt-2">
                                                        <div
                                                            ...
                                                            role="progressbar" style={{width: item.size}}
                            ...
                            <Row>
                                <Col lg={12}>
                                    <div className="text-center mb-3">
                                        <button className="btn btn-link shadow-none text-success mt-2"><i
                                            className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more
                                        </button>
                                    </div>
                                </Col>
                            </Row>
                                            ...
                                            {topDrop.map((item, key) => (<tr key={key}>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="ms-2">
                                                            <Link to="/apps-nft-item-details"><h6
                                                                className="fs-15 mb-1">{item.title}</h6></Link>
                                    ...
                                    <div className="table-responsive table-card">
                                        <table className="table table-borderless align-middle">
                                            ...
                                            {topCreator.map((item, key) => (<tr key={key}>
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <img src={item.img} alt=""
                                                             className="avatar-sm object-cover rounded-circle"/>
                                                        <div className="ms-2">
                                                            <Link to="#!"><h6 className="fs-15 mb-1">{item.name}</h6>
                                                            </Link>
                                                ...
                                                <td>
                                                    <button
                                                        className={item.isFollow ? "btn btn-sm btn-success" : "btn btn-sm btn-soft-success"}>{item.isFollow ? "Follow" : "Unfollow"}</button>
                                                </td>
                                            </tr>))}
                                            </tbody>
                                        </table>
