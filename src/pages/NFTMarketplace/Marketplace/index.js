                                ...
                                <Col lg={4} md={6}>
                                    <Card>
                                        <CardBody>
                                            ...
                                            <h5 className="mb-0 fs-16"><Link to="#!">Crypto Card <span
                                                className="badge badge-soft-success">743</span></Link></h5>
                                        </CardBody>
                                    </Card>
                                </Col>
                                ...
                                <Col lg={4} md={6}>
                                    <Card>
                                        <CardBody>
                                            ...
                                            <Link to="#!" className="float-end"> View All <i
                                                className="ri-arrow-right-line align-bottom"></i></Link>
                                            <h5 className="mb-0 fs-16"><Link to="#!">Artwork <span
                                                className="badge badge-soft-success">206</span></Link></h5>
                                        </CardBody>
                                    </Card>
                                </Col>
                                ...
                                <Col lg={4} md={6}>
                                    <Card>
                                        <CardBody>
                                            ...
                                            <Link to="#!" className="float-end"> View All <i
                                                className="ri-arrow-right-line align-bottom"></i></Link>
                                            <h5 className="mb-0 fs-16"><Link to="#!">Music <span
                                                className="badge badge-soft-success">679</span></Link></h5>
                                        </CardBody>
                                    </Card>
                                </Col>
                        ...
                        <Col xl={4}>
                            ...
                            <Card className="bg-primary" style={{backgroundImage: `url(${BgPattern})`}}>
                                <CardBody className="p-4">
                                    ...
                                    <h3 className="text-white lh-base">Discover, Collect, Sell and Create your own
                                        NFT</h3>
                                    <p className="text-white-75 mb-3">Take advantage of the first text-based NFT. Select
                                        a text or write your own and let it live forever on the Ethereum blockchain you
                                        or future owners can add text to an existing ChainText token..</p>
                        ...
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link to="/apps-nft-explore" className="btn btn-primary">View All <i
                                        className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                                        ...
                                        <div className="explore-place-bid-img overflow-hidden rounded">
                                            ...
                                            <div className="place-bid-btn">
                                                <Link to="#!" className="btn btn-success"><i
                                                    className="ri-auction-fill align-bottom me-1"></i> Place Bid</Link>
                                            </div>
                                        </div>
                                        <div className="mt-3">
                                            <p className="fw-medium mb-0 float-end"><i
                                                className="mdi mdi-heart text-danger align-middle"></i> {item.likes}
                                            </p>
                                            <h5 className="text-success"><i
                                                className="mdi mdi-ethereum"></i> {item.price} </h5>
                                            <h6 className="fs-16 mb-0"><Link
                                                to="/apps-nft-item-details">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link to="/apps-nft-creators" className="btn btn-soft-primary">View All <i
                                        className="ri-arrow-right-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </Col>
                            ...
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    <div className="bookmark-icon position-absolute top-0 end-0 p-2">
                                        <button type="button" className="btn btn-icon active" data-bs-toggle="button"
                                                aria-pressed="true"><i className="mdi mdi-cards-heart fs-16"></i>
                                        </button>
                                    </div>
                                    ...
                                    <CardBody>
                                        <p className="fw-medium mb-0 float-end"><i
                                            className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                    ...
                                    <div className="card-footer border-top border-top-dashed">
                                        <div className="d-flex align-items-center">
                                            <div className="flex-grow-1 fs-14">
                                                <i className="ri-price-tag-3-fill text-warning align-bottom me-1"></i> Highest: <span
                                                className="fw-medium">{item.highest}</span>
                                            </div>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <CardBody className="text-center">
                                        ...
                                        <div>
                                            <button
                                                className={item.isFollow ? "btn btn-primary btn-sm" : "btn btn-soft-primary btn-sm"}>{item.isFollow ? "Follow" : "Unfollow"}</button>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
