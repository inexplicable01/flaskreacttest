                                ...
                                <Col lg={4}>
                                    <div className="sticky-side-div">
                                        <Card className="ribbon-box border shadow-none right">
                                            <div className="ribbon-two ribbon-two-danger"><span><i
                                                className="ri-fire-fill align-bottom"></i> Hot</span></div>
                                            <img src={Img5} alt="" className="img-fluid rounded"/>
                                            <div className="position-absolute bottom-0 p-3">
                                                <div
                                                    className="position-absolute top-0 end-0 start-0 bottom-0 bg-white opacity-25"></div>
                                ...
                                <Col lg={8}>
                                    <div>
                                        <UncontrolledDropdown className="float-end">
                                            <DropdownToggle tag="a" className="btn btn-ghost-primary btn-icon"
                                                            role="button">
                                                <i className="ri-more-fill align-middle fs-16"></i>
                                            </DropdownToggle>
                                            <DropdownMenu className="dropdown-menu-end">
                                                <DropdownItem href="#" className="view-item-btn"><i
                                                    className="ri-eye-fill align-bottom me-2 text-muted"></i>View</DropdownItem>
                                                <DropdownItem href="#" className="edit-item-btn"><i
                                                    className="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</DropdownItem>
                                                <DropdownItem href="#" className="remove-item-btn"><i
                                                    className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</DropdownItem>
                                            </DropdownMenu>
                                        </UncontrolledDropdown>

                                        <span className="badge badge-soft-info mb-3 fs-12"><i
                                            className="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                        <h4>Patterns Arts & Culture</h4>
                                        <div className="hstack gap-3 flex-wrap">
                                            <div className="text-muted">Creators : <Link to="#"
                                                                                         className="text-primary fw-medium">Nancy
                                                Martino</Link></div>
                                            <div className="vr"></div>
                                            <div className="text-muted">Seller : <span className="text-body fw-medium">Rickey Teran</span>
                                            </div>
                                            <div className="vr"></div>
                                            <div className="text-muted">Published : <span
                                                className="text-body fw-medium">29 April, 2022</span></div>
                                        </div>
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="p-2 border border-dashed rounded text-center">
                                                    <div>
                                                        ...
                                                        <h5 className="fs-17 text-secondary mb-0"><i
                                                            className="mdi mdi-ethereum me-1"></i> 83.06 ETH</h5>
                                                    </div>
                                                </div>
                                            </Col>
                                        ...
                                        <div className="mt-4 text-muted">
                                            ...
                                            <p>Cultural patterns are the similar behaviors within similar situations we
                                                ...
                                                arrangement of repeated or corresponding parts, decorative motifs,
                                                etc.</p>
                                        </div>
                                            ...
                                            >
                                                                ...
                                                                <th scope="row">
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <Link to="/apps-nft-item-details"
                                                                              className="link-dark"><span
                                                                            className="mb-0 ms-2">Brave Tigers NFT</span></Link>
                                                                    </div>
                                                                </th>
                                                                <td>0.235 ETH</td>
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        <img src={avatar1} alt=""
                                                                             className="avatar-xs rounded object-cover"/>
                                                                        <div className="ms-2">
                                                                            <Link to="#!"><h6 className="mb-1">Alexis
                                                                                Clarke</h6></Link>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <Link to="/apps-nft-item-details"
                                                                              className="link-dark"><span
                                                                            className="mb-0 ms-2">Creative filtered portrait</span></Link>
                                                                    </div>
                                                                </th>
                                                                <td>571.24 ETH</td>
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        <img src={avatar3} alt=""
                                                                             className="avatar-xs rounded object-cover"/>
                                                                        <div className="ms-2">
                                                                            <Link to="#!"><h6 className="mb-1">Glen
                                                                                Matney</h6></Link>
                                                                            <p className="text-muted mb-0">Creators</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <Link to="/apps-nft-item-details"
                                                                              className="link-dark"><span
                                                                            className="mb-0 ms-2">Evolved Reality</span></Link>
                                                                    </div>
                                                                </th>
                                                                <td>130.39 ETH</td>
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        <img src={avatar5} alt=""
                                                                             className="avatar-xs rounded object-cover"/>
                                                                        <div className="ms-2">
                                                                            <Link to="#!"><h6 className="mb-1">Herbert
                                                                                Stokes</h6></Link>
                                                                            <p className="text-muted mb-0">Creators</p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <Link to="/apps-nft-item-details"
                                                                              className="link-dark"><span
                                                                            className="mb-0 ms-2">Robotic Body Art</span></Link>
                                                                    </div>
                                                                </th>
                                                                <td>81.72 ETH</td>
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        <img src={avatar8} alt=""
                                                                             className="avatar-xs rounded object-cover"/>
                                                                        <div className="ms-2">
                                                                            <Link to="#!"><h6 className="mb-1">Michael
                                                                                Morris</h6></Link>
                                                                            <p className="text-muted mb-0">Creators</p>
                                                                        </div>
                                                                    </div>
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <div>
                                                            <p className="mb-2"><i
                                                                className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> On
                                                                digital or printed media</p>
                                                            <p className="mb-2"><i
                                                                className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> For
                                                                commercial and personal projects</p>
                                                            <p className="mb-2"><i
                                                                className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> From
                                                                anywhere in the world</p>
                                                            <p className="mb-0"><i
                                                                className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> Full
                                                                copyrights sale</p>
                                                        </div>
                                                    </div>
                                                </TabPane>
                                            ...
                                            <Row className="gy-4 gx-0">
                                                        ...
                                                        <div className="pb-3">
                                                            ...
                                                            <div className="text-center">
                                                                <div className="text-muted">Total <span
                                                                    className="fw-medium">7.32k</span> reviews
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <Col lg={8}>
                                                    <div className="ps-lg-4">
                                                        ...
                                                        <SimpleBar className="me-lg-n3 pe-lg-4"
                                                                    ...
                                                                    <div className="border border-dashed rounded p-3">
                                                                        <div className="d-flex align-items-start mb-3">
                                                                            <div className="hstack gap-3">
                                                                                ...
                                                                                <div className="vr"></div>
                                                                                <div className="flex-grow-1">
                                                                                    <p className="text-muted mb-0"> Superb
                                                                        ...
                                                                        <div className="d-flex align-items-end">
                                                                            ...
                                                                            <div className="flex-shrink-0">
                                                                                <p className="text-muted fs-13 mb-0">12
                                                                                    Jul, 21</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="border border-dashed rounded p-3">
                                                                        <div className="d-flex align-items-start mb-3">
                                                                            <div className="hstack gap-3">
                                                                                ...
                                                                                <div className="vr"></div>
                                                                                <div className="flex-grow-1">
                                                                                    <p className="text-muted mb-0"> Great
                                                                        ...
                                                                        <div className="d-flex align-items-end">
                                                                            ...
                                                                            <div className="flex-shrink-0">
                                                                                <p className="text-muted fs-13 mb-0">06
                                                                                    Jul, 21</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="border border-dashed rounded p-3">
                                                                        <div className="d-flex align-items-start mb-3">
                                                                            <div className="hstack gap-3">
                                                                                ...
                                                                                <div className="vr"></div>
                                                                                <div className="flex-grow-1">
                                                                                    <p className="text-muted mb-0">Good
                                                                    ...
                                                                    <div className="border border-dashed rounded p-3">
                                                                        <div className="d-flex align-items-start mb-3">
                                                                            <div className="hstack gap-3">
                                                                                ...
                                                                                <div className="vr"></div>
                                                                                <div className="flex-grow-1">
                                                                                    <p className="text-muted mb-0">Nice
                                                                        ...
                                                                        <div className="d-flex align-items-end">
                                                                            ...
                                                                            <div className="flex-shrink-0">
                                                                                <p className="text-muted fs-13 mb-0">24
                                                                                    Jun, 21</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
