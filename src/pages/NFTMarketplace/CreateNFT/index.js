                                ...
                                <CardBody>
                                    <Form>
                                        <Row className="g-3">
                                            ...
                                            <Col lg={12}>
                                                <label htmlFor="externalLink" className="form-label">External
                                                    link</label>
                                                <input type="text" className="form-control" id="externalLink"
                                            ...
                                            <Col lg={4}>
                                                ...
                                                <input type="text" className="form-control" id="properties"
                                            ...
                                            <Col lg={12}>
                                                <div>
                                                    <div className="form-check form-check-inline">
                                                        ...
                                                        <label className="form-check-label" htmlFor="inlineCheckbox1">Put
                                                            on sale</label>
                                                    </div>
                                                    <div className="form-check form-check-inline">
                                                        <input className="form-check-input" type="checkbox"
                                                               id="inlineCheckbox2" value="option2"/>
                                                        <label className="form-check-label" htmlFor="inlineCheckbox2">Instant
                                                            sale price</label>
                                                    </div>
                                                    <div className="form-check form-check-inline">
                                                        <input className="form-check-input" type="checkbox"
                                                               id="inlineCheckbox3" value="option3"/>
                                                        <label className="form-check-label" htmlFor="inlineCheckbox3">Unlock
                                                            one purchased</label>
                                                    </div>
                                                </div>
                                            </Col>
