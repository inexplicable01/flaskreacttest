...
const FileManager = () => {
    ...
    return (
        <React.Fragment>
                            ...
                            <div className="p-3 d-flex flex-column h-100">
                                ...
                                <SimpleBar className="mt-3 mx-n4 px-4 file-menu-sidebar-scroll">
                                    <ul className="list-unstyled file-manager-menu">
                                        ...
                                        <li>
                                            <a href="#!" className={filterActive === "Documents" ? "active" : ""}
                                               onClick={() => fileCategory("Documents", "Documents")}><i
                                                className="ri-file-list-2-line align-bottom me-2"></i> <span
                                                className="file-list-link">Documents</span></a>
                                        </li>
                                        <li>
                                            <a href="#!" className={filterActive === "Media" ? "active" : ""}
                                               onClick={() => fileCategory("Media", "Media")}><i
                                                className="ri-image-2-line align-bottom me-2"></i> <span
                                                className="file-list-link">Media</span></a>
                                        </li>
                                        <li>
                                            <a href="#!" className={filterActive === "Recents" ? "active" : ""}
                                               onClick={() => fileCategory("Media", "Recents")}><i
                                                className="ri-history-line align-bottom me-2"></i> <span
                                                className="file-list-link">Recents</span></a>
                                        </li>
                                        <li>
                                            <a href="#!" className={filterActive === "Important" ? "active" : ""}
                                               onClick={() => fileCategory("Documents", "Important")}><i
                                                className="ri-star-line align-bottom me-2"></i> <span
                                                className="file-list-link">Important</span></a>
                                        </li>
                                        <li>
                                            <a href="#!" className={filterActive === "Deleted" ? "active" : ""}
                                               onClick={() => fileCategory("Deleted", "Deleted")}><i
                                        ...
                                        <Col className="col-auto">
                                            <div className="d-flex gap-2 align-items-start">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => handleFolderClicks()}><i
                                                    className="ri-add-line align-bottom me-1"></i> Create Folders
                                                </button>
                                            </div>
                                        </Col>
                                    </Row>
                                                ...
                                                <Card className="bg-light shadow-none" id={"folder-" + item.id}>
                                                    <CardBody>
                                                        <div className="d-flex mb-1">
                                                            <div
                                                                ...
                                                                <input className="form-check-input" type="checkbox"
                                                                       value="" id={"folderlistCheckbox_" + item.id}/>
                                                            ...
                                                            <UncontrolledDropdown>
                                                                <DropdownToggle tag="button"
                                                                                className="btn btn-ghost-primary btn-icon btn-sm dropdown shadow-none">
                                                                    <i className="ri-more-2-fill fs-16 align-bottom"/>
                                                                </DropdownToggle>
                                                                <DropdownMenu className="dropdown-menu-end">
                                                                    <DropdownItem
                                                                        className="view-item-btn">Open</DropdownItem>
                                                                    <DropdownItem className="edit-folder-list"
                                                                                  onClick={() => handleFolderClick(item)}>Rename</DropdownItem>
                                                        ...
                                                        <div className="hstack mt-4 text-muted">
                                                            <span
                                                                className="me-auto"><b>{item.folderFile}</b> Files</span>
                                    ...
                                    <div className="table-responsive">
                                        <table className="table align-middle table-nowrap mb-0">
                                            ...
                                            {(fileList || []).map((item, key) => (
                                                <tr key={key}>
                                                    <td>
                                                        <input className="form-control filelist-id" type="hidden"
                                                               value="1" id="filelist-1"/>
                                                        <div className="d-flex align-items-center">
                                                            <div className="flex-shrink-0 fs-17 me-2 filelist-icon">
                                                                <i className={item.icon + " text-" + item.iconClass + " align-bottom"}/>
                                                            </div>
                                                            <div
                                                                className="flex-grow-1 filelist-name">{item.fileName}</div>
                                                            <div
                                                                className="d-none filelist-type"> {item.fileType} </div>
                                                        </div>
                                                    </td>
                                                    <td>{item.fileItem}</td>
                                                    ...
                                                    <td>
                                                        <div className="d-flex gap-3 justify-content-center">
                                                            ...
                                                            <UncontrolledDropdown dir='start'>
                                                                ...
                                                                <DropdownMenu className="dropdown-menu-end">
                                                                    <DropdownItem className="viewfile-list"
                                                                                  onClick={() => {
                                                                                      setSidebarData(item);
                                                                                      fileSidebar();
                                                                                      sidebarOpen("file-detail-show")
                                                                    ...
                                                                    <DropdownItem className="edit-list"
                                                                                  onClick={() => handleFileClick(item)}>Rename</DropdownItem>
                                                                    <DropdownItem divider/>
                                                                    <DropdownItem className="remove-list"
                                                                                  onClick={() => onClickFileDelete(item)}>Delete</DropdownItem>
                                                                </DropdownMenu>
                                                            </UncontrolledDropdown>
                                                        </div>
                                                    </td>
                            ...
                            <SimpleBar className="mx-n3 pt-3 px-3 file-detail-content-scroll">
                                <div id="folder-overview">
                                    ...
                                    <SimpleDonutCharts
                                        ...
                                        className="apex-charts mt-3" dir="ltr"/>
                                    <div className="mt-4">
                                        ...
                                        <div className="alert alert-danger d-flex align-items-center mb-0">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <button className="btn btn-sm btn-danger"><i
                                                    className="ri-upload-cloud-line align-bottom"></i> Upgrade Now
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="file-overview" className="h-100">
                                    <div className="d-flex h-100 flex-column">
                                        ...
                                        <div className="pb-3 border-bottom border-bottom-dashed mb-3">
                                            ...
                                            <button type="button"
                                                    className="btn btn-icon btn-sm btn-ghost-success float-end fs-16"><i
                                                className="ri-share-forward-line"></i></button>
                                            <h5 className="fs-16 mb-1 file-name">{sidebarData.fileName}</h5>
                                            <p className="text-muted mb-0 fs-12"><span
                                                className="file-size">{sidebarData.size}</span>, <span
                                                className="create-date">{sidebarData.createDate}</span></p>
                                        </div>
                                        <div>
                                                ...
                                                <table className="table table-borderless table-nowrap table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="file-path">
                                                            <div
                                                                className="user-select-all text-truncate">*:\projects\src\assets\images
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                        ...
                                        <div className="mt-auto border-top border-top-dashed py-3">
                                            <div className="hstack gap-2">
                                                ...
                                                <button type="button"
                                                        ...
                                                        onClick={() => onClickFileDelete(sidebarData)}><i
            ...
            {/* Folder Modal */}
            <Modal className="fade zoomIn" isOpen={modalFolder} toggle={() => setModalFolder(!modalFolder)}
                   id="createFolderModal" modalClassName="zoomIn" centered tabIndex="-1">
                <ModalHeader className="p-3 bg-soft-success" id="createFolderModalLabel"
                             toggle={() => setModalFolder(!modalFolder)}> {isEdit ? "Folder Rename" : "Create Folder"} </ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success"
                                    onClick={() => setModalFolder(false)}><i
                                className="ri-close-line align-bottom"></i> Close
                            </button>
                            <button type="submit" className="btn btn-primary"
                                    id="addNewFolder">{isEdit ? "Save" : "Add Folder"}</button>
                        </div>
                    </form>
                </ModalBody>
            </Modal>
            ...
            {/* File Modal */}
            <Modal id="createFileModal" isOpen={modalFile} toggle={fileToggle} modalClassName="zoomIn" centered
                   tabIndex="-1">
                <ModalHeader toggle={fileToggle}
                             className="p-3 bg-soft-success">{!!isEdit ? "File Rename" : "Create File"}</ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success" onClick={() => setModalFile(false)}>
                                <i className="ri-close-line align-bottom"></i> Close
                            </button>
                            <button type="submit" className="btn btn-primary"
                                    id="addNewFile">{!!isEdit ? "Save" : "Create"}</button>
                        </div>
                    </form>
                </ModalBody>
            </Modal>
