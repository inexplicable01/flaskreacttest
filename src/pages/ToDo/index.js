        ...
        <React.Fragment>
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        <div className="file-manager-sidebar">
                            <div className="p-4 d-flex flex-column h-100">
                                <div className="mb-3">
                                    <button className="btn btn-success w-100" onClick={() => setModalProject(true)}><i
                                        className="ri-add-line align-bottom"></i> Add Project
                                    </button>
                                </div>
                                ...
                                <SimpleBar className="px-4 mx-n4" style={{height: "calc(100vh - 468px)"}}>
                                    <ul className="to-do-menu list-unstyled" id="projectlist-data">
                                        {(projects || []).map((item, key) => (
                                            ...
                                            <li key={key}>
                                                <Link to="#" className="nav-link fs-14"
                                                      id={"todos" + key}>{item.title}</Link>
                                                <UncontrolledCollapse toggler={"#todos" + key}>
                                                    <ul className="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                                        {(item.subItem || []).map((item, key) => (<li key={key}>
                                                            <Link to="#"><i
                                                                className={"ri-stop-mini-fill align-middle fs-15 text-" + item.iconClass}></i> {item.version}
                                                            </Link>
                                                        </li>))}
                                                    </ul>
                                                </UncontrolledCollapse>
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0">
                            <Row className="mb-4">
                                ...
                                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                                    <h5 className="fw-semibold mb-0">Velzon Admin & Dashboard <span
                                        className="badge bg-primary align-bottom ms-2">v2.0.0</span></h5>
                                </div>

                                <div className="col-auto order-2 order-sm-3 ms-auto">
                                    <div className="hstack gap-2">
                                        <div className="btn-group" role="group" aria-label="Basic example">
                                            <button className="btn btn-icon fw-semibold btn-soft-danger shadow-none"><i
                                                className="ri-arrow-go-back-line"></i></button>
                                            <button className="btn btn-icon fw-semibold btn-soft-success shadow-none"><i
                                                className="ri-arrow-go-forward-line"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </Row>
                            <div className="p-3 bg-light rounded mb-4">
                                <Row className="g-2">
                                    <Col className="col-lg-auto">
                                        <select className="form-control" name="choices-select-sortlist"
                                                id="choices-select-sortlist" onChange={(e) => taskSort(e.target.value)}>
                                    ...
                                    <Col className="col-lg-auto">
                                        <select className="form-control" name="choices-select-status"
                                                id="choices-select-status" onChange={(e) => taskStatus(e.target.value)}>
                                    ...
                                    <Col className="col-lg">
                                        <div className="search-box">
                                            <input type="text" id="searchTaskList" className="form-control search"
                                                        ...
                                                        <div className="flex-grow-1">
                                                            <div className="form-check">
                                                                ...
                                                                <label className="form-check-label"
                                                                       htmlFor={"todo" + item.id}>{item.task} </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <Modal id="createTask" isOpen={modalTodo} toggle={toggle} modalClassName="zoomIn" centered tabIndex="-1">
                <ModalHeader toggle={toggle}
                             className="p-3 bg-soft-success"> {!!isEdit ? "Edit Task" : "Create Task"} </ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="mb-3">
                            ...
                            <Input type="text" id="task-title-input" className="form-control"
                        ...
                        <div className="mb-3 position-relative">
                            ...
                            <div className="select-element">
                                <button className="btn btn-light w-100 d-flex justify-content-between" type="button"
                                        onClick={() => setDroplist(!droplist)}>
                                    <span>Assigned To<b id="total-assignee" className="mx-1">0</b>Members</span> <i
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success" onClick={() => setModalTodo(false)}>
                                <i className="ri-close-fill align-bottom"></i> Close
                            </button>
                            <button type="submit" className="btn btn-primary"
                                    id="addNewTodo">{!!isEdit ? "Save" : "Add Task"}</button>
                        </div>
                    </Form>
                </ModalBody>
            </Modal>
            ...
            {/* Projects */}
            <Modal id="createProjectModal" isOpen={modalProject} toggle={() => setModalProject(!modalProject)}
                   modalClassName="zoomIn" tabIndex="-1" centered>
                <ModalHeader toggle={() => setModalProject(!modalProject)} className="p-3 bg-soft-success"
                ...
                <ModalBody>
                    <form onSubmit={(e) => {
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success shadow-none"
                                    onClick={() => setModalProject(false)}><i
