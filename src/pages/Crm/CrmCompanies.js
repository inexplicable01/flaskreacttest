        ...
        () => [
            {
                Header: <input type="checkbox" id="checkBoxAll" className="form-check-input"
                               onClick={() => checkedAll()}/>,
                Cell: (cellProps) => {
                    return <input type="checkbox" className="companyCheckBox form-check-input"
                                  value={cellProps.row.original._id} onChange={() => deleteCheckbox()}/>;
                },
                id: '#',
            },
            {
                                ...
                                <CardHeader>
                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                        <div className="flex-grow-1">
                                            <button className="btn btn-info add-btn" onClick={() => {
                                                setIsEdit(false);
                                                toggle();
                                            }}>
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="hstack text-nowrap gap-2">
                                                ...
                                                <button className="btn btn-soft-success"
                                                        onClick={() => setIsExportCSV(true)}>Export
                                                </button>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle
                                                        href="#"
                                                        ...
                                                        <div className="text-center">
                                                            <div className="position-relative d-inline-block">
                                                                <div className="position-absolute bottom-0 end-0">
                                                                    ...
                                                                    <Input name="img" className="form-control d-none"
                                                    ...
                                                    <Col lg={6}>
                                                        <div>
                                                            ...
                                                            {validation.touched.owner && validation.errors.owner ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.owner}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            {validation.touched.star_value && validation.errors.star_value ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.star_value}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            {validation.touched.location && validation.errors.location ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.location}</FormFeedback>
                                                            ) : null}
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            {validation.touched.employee && validation.errors.employee ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.employee}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                    ...
                                                    <Col lg={6}>
                                                        <div>
                                                            ...
                                                            {validation.touched.contact_email && validation.errors.contact_email ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.contact_email}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </Col>
                                                    <Col lg={12}>
                                                        <div>
                                                            ...
                                                            {validation.touched.since && validation.errors.since ? (
                                                                <FormFeedback
                                                                    type="invalid">{validation.errors.since}</FormFeedback>
                                                            ) : null}
                                                        </div>
                                                    </Col>
                                                </Row>
                                            ...
                                            <ModalFooter>
                                                <div className="hstack gap-2 justify-content-end">
                                                    ...
                                                    <Button type="submit" color="success"
                                                            id="add-btn">  {!!isEdit ? "Update" : "Add Company"} </Button>
                                                </div>
                                            </ModalFooter>
                                        </Form>
                                    </Modal>
                                        ...
                                        <div className="avatar-md">
                                            <div className="avatar-title bg-light rounded-circle">
                                                <img
                                                    ...
                                                    alt="" className="avatar-sm rounded-circle object-cover"/>
                                            </div>
                                        </div>
                                    </div>
